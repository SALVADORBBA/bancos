...
class ClienteList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $beneficiario_id = new TDBCombo('beneficiario_id', 'conecatarbanco', 'Beneficiario', 'id', '{nome}','id asc' , $criteria_beneficiario_id );
        ...
        $row1 = $this->form->addFields([new TLabel("CÓDIGO:", null, '14px', null, '100%'),$id],[new TLabel("RAZÃO SOCIAL:", null, '14px', null, '100%'),$razao_social],[new TLabel("BENEFICIÁRIO:", null, '14px', null, '100%'),$beneficiario_id],[new TLabel("CPF/CNPJ:", null, '14px', null, '100%'),$cpf_cnpj]);
        ...
        $column_nome = new TDataGridColumn('nome', "NOME FANTASIA", 'left');
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastros","Clientes"]));
        }
