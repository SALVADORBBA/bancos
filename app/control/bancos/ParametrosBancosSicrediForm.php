...
class ParametrosBancosSicrediForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $row19 = $this->form->addFields([new TLabel(new TImage('fas:user-secret #FF5722')."CLIENT ID BOLETO:", '#FF5722', '14px', 'B', '100%'),$client_id],[new TLabel(new TImage('fas:user-friends #009688')."LOGIN:", '#009688', '14px', 'B', '100%'),$username],[new TLabel(new TImage('fas:keyboard #E91E63')."SENHA::", '#E91E63', '14px', 'B', '100%'),$password],[new TLabel("URL TOKEN: ", null, '14px', 'B'),$url1],[new TLabel("URL AÇÕES DO BOLETO:", null, '14px', 'B'),$url2]);
        $row19->layout = ['col-sm-6','col-sm-3','col-sm-3',' col-sm-12',' col-sm-12'];
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Bancos","Cadastro de parametros bancos"]));
        }
